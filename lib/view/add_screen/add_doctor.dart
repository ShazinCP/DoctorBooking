...
class AddandEditDoctor extends StatefulWidget {
  ...
  const AddandEditDoctor({Key? key, this.doctor}) : super(key: key);
...
class _AddandEditDoctorState extends State<AddandEditDoctor> {
  ...
  void initState() {
    ...
    if (widget.doctor != null) {
      ...
      provider.qualificationController.text = widget.doctor!.qualification ?? '';
  ...
  child: CircleAvatar(
    ...
    backgroundImage: provider.selectedImage != null
        ...
        : const NetworkImage('https://heatherdalecounselling.co.uk/http/www.slk.happyvalentinesday2020.online/person-icon-png-db7f.png'), // Replace with a valid image URL
